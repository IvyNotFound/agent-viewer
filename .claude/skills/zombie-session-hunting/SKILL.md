...
description: Diagnose and clean up zombie sessions in KanbAgent. Activates when sessions are stuck, dbstart returns unexpected errors, or user says "stuck sessions", "clean the DB", "kill zombie sessions", "sessions stuck".
---
