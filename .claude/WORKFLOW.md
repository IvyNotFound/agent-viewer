...
sessions        (id PK, agent_id→agents, started_at, ended_at, updated_at, status CHECK(status IN ('started','completed','blocked')), summary, conv_id, tokens_in, tokens_out, tokens_cache_read, tokens_cache_write, cli_type, cost_usd, duration_ms, num_turns, model_used)
