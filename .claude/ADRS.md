...
> Split across multiple files due to size: ADR-004 to ADR-006 → `ADRS-004-006.md` · ADR-007 → `ADRS-007.md` · ADR-008 to ADR-009 → `ADRS-008-009.md` · ADR-010 → `ADRS-010.md` · ADR-011 → `ADRS-011.md` · ADR-012 → `ADRS-012.md` · ADR-013 → `ADRS-013.md`
